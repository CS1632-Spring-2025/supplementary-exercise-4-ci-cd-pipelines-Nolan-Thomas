...
public class RentACatUnitTest {
	...
	public void setUp() throws Exception {
		...
		Mockito.when(c1.getName()).thenReturn("Jennyantdots");
	...
	public void testListCatsNumCats3() {
		...
		r.addCat(c3);
		String catList = r.listCats();
		assertEquals("ID 1. Jennyanydots" + newline + "ID 2. Old Deuteronomy" + newline+ "ID 3. Mistoffelees" + newline, catList);
	}
	...
	public void testRenameFailureNumCats0() {
		...
		assertFalse(ret);
		//Mockito.verify(c1, never()).renameCat("Garfield");
		assertNotEquals("Garfield", c1.getName());
		assertEquals("Invalid cat ID." + newline, out.toString());
	}
	...
	public void testRenameNumCat3() {
		...
		} catch (MockitoAssertionError | MissingMethodInvocationException | NotAMockException e) {}
	...
	public void testRentCatFailureNumCats3() {
		...
		try {
			Mockito.when(c2.getRented()).thenReturn(true); //"renting" cat 2
